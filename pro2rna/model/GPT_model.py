...
class GPTConfig:
    ...
    def to_dict(self):
        ...
        return {
            ...
            'bias': self.bias,
            'tie_word_embeddings': False,  # 添加这个属性以兼容LoRA
            'is_encoder_decoder': False,  # 添加这个属性
            'max_position_embeddings': self.block_size,  # 添加这个属性
            'hidden_size': self.n_embd,  # 添加这个属性
            'num_attention_heads': self.n_head,  # 添加这个属性
            'num_hidden_layers': self.n_layer,  # 添加这个属性
        }
...
class GPT(nn.Module):
    ...
    def __init__(self, config):
        ...
        if not hasattr(config, 'max_position_embeddings'):
            config.max_position_embeddings = config.block_size
